...
| `web-ai/` | 90 | 19993 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 90 | 8777 | deterministic module tests |
| `test/integration/` | 16 | 2173 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 286 | 34600 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 1568 | `web-ai` subcommand parser and command orchestration |
