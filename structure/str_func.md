...
| `web-ai/` | 100 | 23396 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 112 | 13705 | deterministic module tests |
...
| `devlog/` | 378 | 47737 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 1040 | ChatGPT provider send/poll/query/status |
