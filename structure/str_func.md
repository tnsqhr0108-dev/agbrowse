...
| `skills/browser/` | 45 | 13600 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, Runway task-runner preflight/poll |
| `skills/vision-click/` | 4 | 1182 | screenshot to coordinate click helper |
| `skills/web-ai/` | 3 | 842 | bundled agent workflow skill |
| `web-ai/` | 96 | 21975 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 105 | 12355 | deterministic module tests |
| `test/integration/` | 17 | 2465 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 366 | 45308 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3465 | root CLI parser, Chrome lifecycle, browser primitive commands |
...
| `web-ai/cli.mjs` | 1882 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/chatgpt.mjs` | 942 | ChatGPT provider send/poll/query/status |
