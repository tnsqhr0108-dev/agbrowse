...
| `test/unit/` | 94 | 10444 | deterministic module tests |
...
| `docs/` | 8 | 1944 | adoption, trace, production-readiness, comparison, benchmark, EXTERNAL_CDP, migration docs |
| `devlog/` | 296 | 36474 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3122 | root CLI parser, Chrome lifecycle, browser primitive commands |
...
| `web-ai/chatgpt.mjs` | 919 | ChatGPT provider send/poll/query/status |
