...
| `web-ai/` | 93 | 20601 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 100 | 11446 | deterministic module tests |
...
| `devlog/` | 337 | 41681 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 1633 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/chatgpt.mjs` | 921 | ChatGPT provider send/poll/query/status |
